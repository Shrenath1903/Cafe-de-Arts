...
const ITEMS = [
  ...
  D({id:"v3",cat:"viennoiseries",name:"Muffin / Chocolate and Blueberry",price:"₹220",img:"./img/m.jpeg",
  ...
  D({id:"e4",cat:"eggs",name:"Masala Tofu Scramble",price:"₹380", img:"./img/masala_tofu_scramble.png",
  ...
  // ---------------- BRUNCH PLATES ----------------
  D({id:"b1",cat:"brunch",name:"Croissant Florentine",price:"₹390",img:"./img/croissant_florentine.png",
  ...
  D({id:"b2",cat:"brunch",name:"Brunch Waffle",price:"₹420",img:"./img/brunch_waffle.png",
  ...
  D({id:"b3",cat:"sandwiches",name:"Croque Madame",price:"₹540",img:"./img/croque_madame.jpeg",
  ...
  D({id:"c2",cat:"crepewaffle",name:"Ganache",price:"₹440 / ₹480",img:"./img/ganache.png",
  ...
  D({id:"c3",cat:"crepewaffle",name:"Banoffee",price:"₹340 / ₹390",img:"./img/banoffee.png",
  ...
  D({id:"c4",cat:"crepewaffle",name:"Tutti Frutti",price:"₹430 / ₹450",img:"./img/tutti_frutti.png",
  ...
  // ---------------- SAVORY CRÊPES ----------------
  D({id:"s1",cat:"savorycrepes",name:"Mushroom & Spinach Crêpe",price:"₹410",img:"./img/mushroom_spinach_crepe.png",
  ...
  D({id:"s2",cat:"savorycrepes",name:"Chicken & Basil Crêpe",price:"₹470",img:"./img/chicken_basil_crepe.jpeg",
  ...
  D({id:"s3",cat:"savorycrepes",name:"Bacon & Cheese Crêpe",price:"₹460",img:"./img/bacon_cheese_crepe.png",
  ...
  D({id:"s4",cat:"savorycrepes",name:"Pondy 'Chérie' Crêpe",price:"₹480",img:"./img/pondy_cherie_crepe.jpeg",
  ...
  // ---------------- SANDWICHES ----------------
  D({id:"sw1",cat:"sandwiches",name:"The Kiddo",price:"₹440",img:"./img/the_kiddo.jpeg",
  ...
  D({id:"sh4",cat:"share",name:"Chicken Nuggets",price:"₹410",img:"./img/chicken_nuggets.png",
  ...
  // ---------------- TARTINES ----------------
  D({id:"ta1",cat:"tartines",name:"Forest Tartine",price:"₹490",img:"./img/forest_tartine.png",
  ...
  D({id:"ta2",cat:"tartines",name:"Caprese Tartine",price:"₹480",img:"./img/caprese_tartine.png",
  ...
  D({id:"ta3",cat:"tartines",name:"Mediterranean Tartine",price:"₹480",img:"./img/mediterranean_tartine.png",
  ...
  // ---------------- COFFEE & TEA ----------------
  D({id:"coffee_1",cat:"coffee",name:"Espresso",price:"₹150",img:"./img/espresso.jpeg",
  ...
  D({id:"coffee_2",cat:"coffee",name:"Americano",price:"₹220",img:"./img/americano.jpeg",
  ...
  D({id:"coffee_3",cat:"coffee",name:"Latte",price:"₹220", img:"./img/latte.jpeg",
  ...
  D({id:"coffee_4",cat:"coffee",name:"Cappuccino",price:"₹250",img:"./img/cappuccino.jpeg",
  ...
  D({id:"coffee_6",cat:"coffee",name:"Cortado",price:"₹240",img:"./img/cortado.jpeg",
  ...
  D({id:"coffee_7",cat:"coffee",name:"Viennois",price:"₹220",img:"./img/viennois.jpeg",
  ...
  D({id:"coffee_8",cat:"coffee",name:"Mocha",price:"₹250",
    desc:"Smooth espresso blended with chocolate and steamed milk.", img:"./img/mocha.jpeg",
  ...
  D({id:"coffee_10",cat:"coffee",name:"Irish Cold Coffee",price:"₹300",img:"./img/irish_cold_coffee.jpeg",
  ...
  D({id:"coffee_11",cat:"coffee",name:"Affogato",price:"₹220",img:"./img/affogato.jpeg",
  ...
  D({id:"coffee_11",cat:"coffee",name:"Cafe Bombon Hot / Iced",price:"₹220 / ₹250",img:"./img/cafe_bombon.jpeg",
    desc:"A shot of hot espresso poured over scoop of Vanilla Ice Cream.",
    taste:["Creamy","Chocolatey","Intense"],
    health:["Indulgent Dessert"],
    nutrition:{cal:220,protein:4,carbs:20,fat:11}, diet:"veg", spice:0,
    pairing:"A sweet little finale", prep:"3 mins", badges:["bestseller"],
    ...
    freshness:"Built fresh to order.",
    chefTip:"Serve with a spoon and a pause — the espresso should melt the ice cream slightly.", rating:4.9 }),
  D({id:"coffee_12",cat:"coffee",name:"Tiramisu Ice Latte",price:"₹320",img:"./img/tiramisu_ice_latte.jpeg",
  ...
  D({id:"tea_1",cat:"tea",name:"Masala Tea",price:"₹130",img:"./img/masala_tea.jpeg",
  ...
  D({id:"tea_2",cat:"tea",name:"Matcha Latte",price:"₹200",img:"./img/matcha_latte.jpeg",
  ...
  D({id:"tea_3",cat:"tea",name:"Golden Latte",price:"₹190",img:"./img/golden_latte.jpeg",
  ...
  D({id:"tea_9",cat:"tea",name:"Homemade Ice Tea",price:"₹190",
  ...
  // ---------------- DRINKS MENU ----------------
  D({id:"dr1",cat:"juice",name:"Freshly Squeezed Orange Juice",price:"₹240",img:"./img/freshly_squeezed_orange_juice.jpeg",
  ...
  D({id:"dr2",cat:"juice",name:"Watermelon Chia Mint",price:"₹180",img:"./img/watermelon_chia_mint.jpeg",
  ...
  D({id:"dr_papaya",cat:"juice",name:"Papaya Melon",price:"₹250", img:"./img/papaya_melon.png",
  ...
  D({id:"dr5",cat:"juice",name:"Chocolate Smoothie",price:"₹280",img:"./img/chocolate_smoothie.jpeg",
  ...
  D({id:"dr7",cat:"soda",name:"Ginger Lemon Mint Fizz",price:"₹190",img:"./img/ginger_lemon_mint_fizz.jpeg",
  ...
  D({id:"dr8",cat:"soda",name:"Diabolo Soda",price:"₹220",img:"./img/diabolo_soda.jpeg",
  ...
  D({id:"dr10",cat:"soda",name:"Coke",price:"₹100",img:"./img/coke.jpeg",
  ...
  D({id:"dr11",cat:"milkshake",name:"Vanilla Milkshake",price:"₹190",img:"./img/vanilla_milkshake.jpeg",
  ...
  D({id:"dr12",cat:"milkshake",name:"Chocolate Milkshake",price:"₹220",img:"./img/chocolate_milkshake.jpeg",
  ...
  D({id:"dr13",cat:"gingerale",name:"Ginger Ale",price:"₹180",img:"./img/ginger_ale.jpeg",
  ...
  D({id:"dr14",cat:"mineralwater",name:"Still Mineral Water 750 ml",price:"₹110",img:"./img/mineral_water.jpeg",
